<template>
    <router-link to="/Music">
        <div id="svg" class="air-svg">
            ...
            >
                <path :fill="color" d="M6.979,271.181c30.288,25.979,64.616,55.426,131.017,55.426c66.403-0.001,100.733-29.447,131.022-55.426
                    ...
                    C-2.372,251.363-1.405,263.99,6.979,271.181z"></path>
                <path :fill="color" d="M6.979,161.787c30.287,25.98,64.615,55.426,131.017,55.426c66.403,0,100.733-29.446,131.022-55.426
                    ...
                    C-2.372,141.969-1.405,154.596,6.979,161.787z"></path>
                <path :fill="color" d="M505.02,350.213c-30.289-25.979-64.619-55.426-131.022-55.426s-100.733,29.446-131.022,55.426
                    ...
                    c8.385,7.191,21.011,6.225,28.202-2.159C514.371,370.03,513.405,357.404,505.02,350.213z"></path>
            </svg>
        </div>
    </router-link>
</template>
